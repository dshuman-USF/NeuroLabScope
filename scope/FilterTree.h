...
extern Widget chunkUnselectButtonW;
extern Widget manualMethodButtonW;
extern int segmentList; /* Lists for holding selected manual and automatic filter blocks */
